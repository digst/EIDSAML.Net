...
using eid.saml20.Schema.XEnc;
using eid.saml20.Schema.XmlDSig;
using eid.saml20.Utils;
using eid.saml20.Validation;
using NUnit.Framework;
using Assertion = eid.saml20.Schema.Core.Assertion;
...
namespace eid.test.saml20
{
    ...
    public class Saml20CoreValidationTest
    {
        ...
        public void WrongVersion()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "Wrong value of version attribute on Assertion element");
        }
        ...
        public void MissingID()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "Assertion element must have the ID attribute set.");
        }
        ...
        public void Issuer()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "Assertion element must have an issuer element.");
        }
        ...
        public void IssuerFormat()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "NameID element has Format attribute which is not a wellformed absolute uri.");
        }
        ...
        public void IssueInstant()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "Assertion element must have the IssueInstant attribute set.");
        }
        ...
        public void TimeRestriction_NotBefore_Invalid()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => validator.ValidateTimeRestrictions(saml20Assertion, new TimeSpan(), DateTime.UtcNow), "Conditions.NotBefore is not within expected range");
        }
        ...
        public void TimeRestriction_NotOnOrAfter_Invalid_Yesterday()
        {
            ...
            Saml20AssertionValidator validator = new Saml20AssertionValidator(AssertionUtil.GetAudiences(), false);
            Assert.Throws<Saml20FormatException>(() => validator.ValidateTimeRestrictions(saml20Assertion, new TimeSpan(), DateTime.UtcNow), "Conditions.NotOnOrAfter is not within expected range");
        }
        ...
        {
            EidFederationConfig sp = EidFederationConfig.GetConfig();
            ...
            try
            {
                ...
                Assertion saml20Assertion = AssertionUtil.GetBasicAssertion();
                Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "The service is not configured to meet any audience restrictions");
            }
            finally
            {
        ...
        public void AudienceRestriction_Invalid_ConfigurationSetup()
        {
            ...
            try
            {
                ...
                Assertion saml20Assertion = AssertionUtil.GetBasicAssertion();
                Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "The service is not configured to meet the given audience restrictions");
            }
            finally
            {
                sp.AllowedAudienceUris.Audiences = origAllowedAudiences;
        ...
        public void AudienceRestriction_Invalid_Assertion()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "Audience element has value which is not a wellformed absolute uri");
        }
        ...
        public void SubjectConfirmation()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => validator.ValidateSubject(saml20Assertion.Subject), "Subject MUST contain either an identifier or a subject confirmation");
        }
        ...
        public void SubjectConfirmation_WrongIdentifier()
        {
            ...
            Saml20SubjectValidator validator = new Saml20SubjectValidator();
            Assert.Throws<Saml20FormatException>(() => validator.ValidateSubject(saml20Assertion.Subject), "Subject must have either NameID, EncryptedID or SubjectConfirmation subelement.");
        }
        ...
        public void SubjectConfirmationEmptyMethod()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => validator.ValidateSubjectConfirmation(sct), "Method attribute of SubjectConfirmation MUST contain at least one non-whitespace character");
        }
        ...
        public void SubjectConfirmationWrongMethod()
        {
            ...
            Saml20SubjectConfirmationValidator validator = new Saml20SubjectConfirmationValidator();
            Assert.Throws<Saml20FormatException>(() => validator.ValidateSubjectConfirmation(sct), "SubjectConfirmation element has Method attribute which is not a wellformed absolute uri.");
        }
        ...
        public void SubjectConfirmationDataEmptyRecipient()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => validator.ValidateSubjectConfirmationData(subjectConfirmationData), "Recipient of SubjectConfirmationData must be a wellformed absolute URI.");
        }
        ...
        public void SubjectConfirmationDataInvalidTimeInterval()
        {
            ...
            Saml20SubjectConfirmationDataValidator validator = new Saml20SubjectConfirmationDataValidator();
            Assert.Throws<Saml20FormatException>(() => validator.ValidateSubjectConfirmationData(subjectConfirmationData), "NotBefore 2008-01-30T17:13:00.5Z MUST BE less than NotOnOrAfter 2008-01-30T16:13:00.5Z on SubjectConfirmationData");
        }
        /// <summary>
        /// Tests the validation of the SubjectConfirmationData {NotBefore, NotOnOrAfter} attributes
        /// </summary>
        ...
        public void SubjectConfirmationData_Invalid_KeyInfoConfirmationData_NoAnyElement()
        {
            ...
            Saml20SubjectConfirmationDataValidator validator = new Saml20SubjectConfirmationDataValidator();
            Assert.Throws<Saml20FormatException>(() => validator.ValidateSubjectConfirmationData(subjectConfirmationData), "SubjectConfirmationData element MUST have at least one " + KeyInfo.ELEMENT_NAME + " subelement");
        }
        ...
        public void SubjectConfirmationData_Invalid_KeyInfoConfirmationData_IncompleteAnyElement()
        {
            ...
            Saml20SubjectConfirmationDataValidator validator = new Saml20SubjectConfirmationDataValidator();
            Assert.Throws<Saml20FormatException>(() => validator.ValidateSubjectConfirmationData(subjectConfirmationData), "SubjectConfirmationData element MUST contain at least one " + KeyInfo.ELEMENT_NAME + " in namespace " + Saml20Constants.XMLDSIG);
        }
        ...
        public void SubjectConfirmationData_Invalid_KeyInfoConfirmationData_IncompleteAnyElement_NoChildren()
        {
            ...
            Saml20SubjectConfirmationDataValidator validator = new Saml20SubjectConfirmationDataValidator();
            Assert.Throws<Saml20FormatException>(() => validator.ValidateSubjectConfirmationData(subjectConfirmationData), "KeyInfo subelement of SubjectConfirmationData MUST NOT be empty");
        }
        ...
        public void SubjectConfirmationData_Method_HolderOfKey_Invalid_NoKeyInfo()
        {
            ...
            Saml20SubjectConfirmationValidator validator = new Saml20SubjectConfirmationValidator();
            Assert.Throws<Saml20FormatException>(() => validator.ValidateSubjectConfirmation(subjectConfirmation), "SubjectConfirmationData element MUST have at least one " + KeyInfo.ELEMENT_NAME + " subelement");
        }
        ...
        public void AuthnStatement_Invalid_AuthnInstant()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "AuthnStatement MUST have an AuthnInstant attribute");
        }        
        ...
        public void AuthnStatement_Invalid_AuthnContextNull()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "AuthnStatement MUST have an AuthnContext element");
        }
        ...
        public void AuthnStatement_Invalid_AuthnContextNoContextItems()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "AuthnContext element MUST contain at least one AuthnContextClassRef, AuthnContextDecl or AuthnContextDeclRef element");
        }
        ...
        public void AuthnStatement_Invalid_AuthnContextClassRef_MustBeFirst()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "AuthnContextClassRef must be in the first element");
        }
        ...
        public void AuthnStatement_Invalid_AuthnContext_Max2Refs()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "AuthnContext MUST NOT contain more than two elements.");
        }
        ...
        public void AuthnStatement_Invalid_AuthnContextClassRefUri()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "AuthnContextClassRef has a value which is not a wellformed absolute uri");
        }
        ...
        public void AuthnStatement_Invalid_AuthnContextDeclRefUri()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "AuthnContextDeclRef has a value which is not a wellformed absolute uri");
        }
        ...
        public void AuthnStatement_Invalid_AuthnContextDecl()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "AuthnContextDecl elements are not allowed in this implementation");
        }
        ...
        public void AuthnStatement_Invalid_AuthnContextAuthenticatingAuthorityUri()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "AuthenticatingAuthority array contains a value which is not a wellformed absolute uri");
        }
        ...
        public void AttributeStatement_Invalid_NoAttributes()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "AttributeStatement MUST contain at least one Attribute or EncryptedAttribute");
        }
        ...
        public void AttributeStatement_Invalid_Attribute()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "Name attribute of Attribute element MUST contain at least one non-whitespace character");
        }
        ...
        public void AttributeStatement_Invalid_Attribute_AnyAttrUnqualified()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "Attribute extension xml attributes MUST BE namespace qualified");
        }
        ...
        public void AttributeStatement_Invalid_EncryptedAttribute_NoData()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "An EncryptedAttribute MUST contain an xenc:EncryptedData element");
        }
        ...
        public void AttributeStatement_Invalid_EncryptedAttribute_WrongType()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => CreateSaml20Token(saml20Assertion), "Type attribute of EncryptedData MUST have value " + Saml20Constants.XENC + "Element" + " if it is present");
        }
        ...
        public void AuthzDecisionStatement_Invalid_Resource()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => validator.ValidateStatement(statement), "Resource attribute of AuthzDecisionStatement is REQUIRED");
        }
        ...
        public void AuthzDecisionStatement_Invalid_MalformedResource()
        {
            ...
            Assert.Throws<Saml20FormatException>(() => validator.ValidateStatement(statement), "Resource attribute of AuthzDecisionStatement has a value which is not a wellformed absolute uri");
        }
        ...
        public void AuthzDecisionStatement_Valid_Resources()
        {
            ...
            eid.saml20.Schema.Core.Action action = new eid.saml20.Schema.Core.Action();
            action.Namespace = "http://valid/namespace";
            statement.Action = new eid.saml20.Schema.Core.Action[] { action };
