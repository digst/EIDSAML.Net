...
using Signature = eid.saml20.Schema.XmlDSig.Signature;
...
namespace eid.test.saml20
{
    ...
    public class SignatureTest
    {
        ...
        {
            Assert.Throws<Saml20Exception>(() => AssertionUtil.DeserializeToken(@"Saml20\Assertions\EvilSaml2Assertion_01"), "Signature could not be verified.");
        }
        ...
        {
            Assert.Throws<Saml20Exception>(() => AssertionUtil.DeserializeToken(@"Saml20\Assertions\EvilSaml2Assertion_02"), "Signature could not be verified.");
        }
        ...
        {
            Assert.Throws<Saml20Exception>(() => AssertionUtil.DeserializeToken(@"Saml20\Assertions\EvilSaml2Assertion_03"), "Signature could not be verified.");
        }
        ...
        public void TestSigning_04()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => new Saml20Assertion(AssertionUtil.GetTestAssertion_01().DocumentElement, new AsymmetricAlgorithm[] { cert.PublicKey.Key }, false), "Document does not contain a signature to verify.");
