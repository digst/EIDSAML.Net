...
using Saml20Assertion = eid.saml20.Saml20Assertion;
...
namespace eid.test.saml20
{
    ...
    {    
        ...
        {            
            ...
            doc.Load(file);            
            XmlElement encryptedDataElement = GetElement(eid.saml20.Schema.XEnc.EncryptedData.ELEMENT_NAME, Saml20Constants.XENC, doc);                        

            
            EncryptedData encryptedData = new EncryptedData();
            encryptedData.LoadXml(encryptedDataElement);

            XmlNodeList nodelist = doc.GetElementsByTagName(eid.saml20.Schema.XmlDSig.KeyInfo.ELEMENT_NAME, Saml20Constants.XMLDSIG);
        ...
        public void GenerateEncryptedAssertion_01()
        {
            ...
            encryptedAssertion.encryptedData = new eid.saml20.Schema.XEnc.EncryptedData();
            encryptedAssertion.encryptedKey = new eid.saml20.Schema.XEnc.EncryptedKey[1];
            encryptedAssertion.encryptedKey[0] = new eid.saml20.Schema.XEnc.EncryptedKey();

            XmlDocument result;
            result = Serialization.Serialize(encryptedAssertion);            

            XmlElement encryptedDataElement = GetElement(eid.saml20.Schema.XEnc.EncryptedData.ELEMENT_NAME, Saml20Constants.XENC, result);
        ...
        public void TestAlgorithmConfiguration_01()
        {
            ...
            Assert.Throws<ArgumentException>(() => encryptedAssertion.SessionKeyAlgorithm = "RSA", "The session key algorithm must be specified using the identifying URIs listed in the specification.");            
        }
