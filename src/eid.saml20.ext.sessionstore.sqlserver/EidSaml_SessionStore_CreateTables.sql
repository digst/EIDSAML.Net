...
--if custom schema is used via the 'eidsaml:SqlServerSessionStoreProvider:Schema' setting, the schema in this script must be edited before applying

USE EIDSAML; -- Change name to the name of the target database.
