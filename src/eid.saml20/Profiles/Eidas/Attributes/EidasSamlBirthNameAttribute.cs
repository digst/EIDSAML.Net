...
namespace eid.saml20.Profiles.Eidas.Attributes
{
    ...
    /// 
    /// </summary>
    public class EidasSamlBirthNameAttribute : EidasAttribute
    {
        /// <summary>
        /// Attribute name
        /// </summary>
        public const string NAME = "http://eidas.europa.eu/attributes/naturalperson/BirthName";
        /// <summary>
        /// Friendly name
        /// </summary>
        public const string FRIENDLYNAME = "BirthName";
