...
namespace eid.saml20.Profiles.Eidas.Attributes
{
    ...
    /// 
    /// </summary>
    public class EidasSamlPersonIdentifierNameAttribute : EidasAttribute
    {
        /// <summary>
        /// Attribute name
        /// </summary>
        public const string NAME = "http://eidas.europa.eu/attributes/naturalperson/PersonIdentifier";
        /// <summary>
        /// Friendly name
        /// </summary>
        public const string FRIENDLYNAME = "PersonIdentifier";
