...
namespace eid.saml20.Profiles.Eidas.Attributes
{
    ...
    /// 
    /// </summary>
    public class EidasSamlGenderNameAttribute : EidasAttribute
    {
        /// <summary>
        /// Attribute name
        /// </summary>
        public const string NAME = "http://eidas.europa.eu/attributes/naturalperson/Gender";
        /// <summary>
        /// Friendly name
        /// </summary>
        public const string FRIENDLYNAME = "Gender";
