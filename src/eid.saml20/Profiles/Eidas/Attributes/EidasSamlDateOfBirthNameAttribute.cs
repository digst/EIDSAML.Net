...
namespace eid.saml20.Profiles.Eidas.Attributes
{
    ...
    /// 
    /// </summary>
    public class EidasSamlDateOfBirthNameAttribute : EidasAttribute
    {
        /// <summary>
        /// Attribute name
        /// </summary>
        public const string NAME = "http://eidas.europa.eu/attributes/naturalperson/DateOfBirth";
        /// <summary>
        /// Friendly name
        /// </summary>
        public const string FRIENDLYNAME = "DateOfBirth";
