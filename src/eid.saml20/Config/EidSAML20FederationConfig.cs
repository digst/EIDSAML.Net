...
namespace eid.saml20.config
{
    ...
    /// xsd -t:eid.saml20.config.SAML20Federation eid.saml20.dll
    /// </summary>
    [Serializable]
    [XmlType(Namespace = ConfigurationConstants.NamespaceUri)]
    [XmlRoot(ConfigurationConstants.SectionNames.EidSAML20Federation, Namespace = ConfigurationConstants.NamespaceUri, IsNullable = false)]
    public class EidSAML20FederationConfig : ConfigurationInstance<EidSAML20FederationConfig>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EidSAML20FederationConfig"/> class.
        /// </summary>
        public EidSAML20FederationConfig()
        {
        ...
        // default to Substantial. Cooresponds to certificate level in the Eidas SAML specification.
        private string _minimumLoa = "http://eidas.europa.eu/LoA/substantial";

        /// <summary>
        /// Gets or sets the minimum level of assurance configuration
        /// </summary>
        [XmlElement(ElementName = "MinimumEidLoa")]
        public string MinimumLoa
        {
            get { return _minimumLoa; }
            set { _minimumLoa = value; }
        }
    ...
    public class Attribute
    {
        ...
        /// </summary>
        [XmlAttribute("friendlyName", Namespace = ConfigurationConstants.NamespaceUri)]
        ...
        /// The context value
        /// </summary>
        [XmlAttribute("contextValue", Namespace = ConfigurationConstants.NamespaceUri)]
    ...
    public class AttributeContext
    {
        ...
        /// Attribute name, eg. urn:oid:2.5.4.5 or urn:oid:2.5.4.3.
        /// </summary>
        [XmlAttribute("value", Namespace = ConfigurationConstants.NamespaceUri)]
        public string value;
    }
