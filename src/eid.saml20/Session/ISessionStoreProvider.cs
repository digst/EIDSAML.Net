...
namespace eid.saml20.Session
{
    ...
    {
        /// <summary>
        /// Initializes the session store provider with configurations from EIDSAML.NET.
        ...
        /// This method is called by the EIDSAML.net component after the user has been logged in.
        /// Must support sliding expiration. Thus, session expiration is reset on each call to this method.
        /// </summary>
