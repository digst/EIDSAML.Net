    ...
    public class Saml20Assertion
    {
        ...
        private ISaml20AssertionValidator AssertionValidator
        {
            get
            {
                ...
                {
                    EidFederationConfig config = EidFederationConfig.GetConfig();
                    ...
                    if (config == null || config.AllowedAudienceUris == null)
                    {
                        if (profile == AssertionProfile.DKSaml)
                            _assertionValidator = new EidasSaml20AssertionValidator(null, _quirksMode);
                        else
                    ...
                    {
                        if (profile == AssertionProfile.DKSaml)
                            _assertionValidator = new EidasSaml20AssertionValidator(config.AllowedAudienceUris.Audiences, _quirksMode);
                        else
