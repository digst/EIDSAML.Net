...
{
    internal class EidasSaml20AssertionValidator : Saml20AssertionValidator
    {
        
        public EidasSaml20AssertionValidator(List<string> allowedAudienceUris, bool quirksMode)
        ...
        private ISaml20SubjectValidator SubjectValidator
        {
            get
            {
                if (_subjectValidator == null)
                    _subjectValidator = new EidasSaml20SubjectValidator();
        ...
        private ISaml20StatementValidator StatementValidator
        {
            get
            {
                if (_statementValidator == null)
                    _statementValidator = new EidasSaml20StatementValidator();
